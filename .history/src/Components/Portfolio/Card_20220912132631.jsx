                ...
                <div className="overlay"onClick={toggleMode}>
                    <div className="model-content d_flex">
                        ...
                        <div className="model-text right">
                         ...
                         <button className='btn_shadow'>LIKE THIS<i className='far fa-thumbs-up'></i></button>
                         <button className='btn_shadow'>VIEW PROJECT<i className='fas fa-chevron-right'></i></button>
                         </div>
                         <button className='close-model btn_shadow'onClick={toggleMode}>
